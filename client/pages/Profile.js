      ...
      {/* Profile body */}
      {
        isLoading ?
          <div className='flex justify-center h-80 place-items-center'>
            <svg className="inline mr-2 w-40 h-40 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
