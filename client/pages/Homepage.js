  ...
  return (
    ...
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6 z-[99]">
        <div class="mt-4 md:mt-0">
            ...
            <h2 class="mb-4 text-6xl tracking-tight font-medium text-white dark:text-white">
              NOW <span className='bg-clip-text text-transparent bg-gradient-to-r from-[#93A9F5] to-[#7278B6]'> EVERYONE </span> <br/>
              CAN PARTICIPATE
            </h2>
            <p class="mb-6 font-light text-[#ddd] md:text-sm dark:text-[#ddd]">A secure, decentralized, immutable and open-platform
for i-voting and vote counting that everyone can trust.</p>
