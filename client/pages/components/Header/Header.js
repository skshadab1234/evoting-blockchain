          ...
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <Link href="/">
              <a className="flex items-center">
                <img src="../Logo.png" className="mr-3 h-[60px] sm:h-[60px]" alt="Candidate Recognization" />
              </a>
            </Link>
            <div className="flex items-center lg:order-2">
              {
                logged == 'logged' ? 
                                        ...
                                        <Link href={'/Profile'}>
                                          <button type='button' className="flex items-center mt-2 space-x-2 px-4 py-2 rounded-md bg-blue-500 text-white hover:bg-blue-600">
                                            ...
                                            <div>
                                                <div className="font-bold md:text-md text-sm">Connected</div>
                                                <div className="md:text-sm text-xs">{formatAddress(address)}</div>
                                            </div>
                                        </button>
                                        </Link> 
                                        :     
               ...
               : logged == 'err_logged' ? 'Something Wrong' : <Link href={"/Login"}>
                  <a className="glassmorphism text-white dark:text-white  font-medium rounded-lg text-sm px-4 
            ...
            <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
              <ul className="flex flex-col mt-4 text-white lg:flex-row lg:space-x-8 lg:mt-0">
                ...
                {
                  logged == 'logged' ? <li>
                    <a href="/Logout" className="block py-2 pr-4 pl-3 lg:hover:text-[#7278B6] lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Logout</a>
                  </li>
                    : ''
                }
              </ul>
