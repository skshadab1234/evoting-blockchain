  ...
  const rewrites = () => {
    ...
    return [
      ...
      },
      {
        ...
        destination: `${url}/voter_profile`,
      },
      {
        source: "/voter_logout",
        destination: `${url}/voter_logout`,
      },
      {
        source: "/add_election",
        destination: `${url}/add_election`,
      },
      {
        source: "/update_election",
        destination: `${url}/update_election`,
      },
      {
        source: "/getAllElections",
        destination: `${url}/getAllElections`,
      },
      {
